...
public final class AnimeDetailsActivity_MembersInjector implements MembersInjector<AnimeDetailsActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.viewModelFactory")
  public static void injectViewModelFactory(AnimeDetailsActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.authRepository")
  public static void injectAuthRepository(AnimeDetailsActivity instance,
      AuthRepository authRepository) {
    instance.authRepository = authRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.sharedPreferencesEditor")
  ...
  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.settingReady")
  @Named("ready")
  ...
  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.sharedPreferences")
  public static void injectSharedPreferences(AnimeDetailsActivity instance,
      SharedPreferences sharedPreferences) {
    instance.sharedPreferences = sharedPreferences;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.tokenManager")
  public static void injectTokenManager(AnimeDetailsActivity instance, TokenManager tokenManager) {
    instance.tokenManager = tokenManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.settingsManager")
  public static void injectSettingsManager(AnimeDetailsActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.authManager")
  ...
  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.mediaRepository")
  public static void injectMediaRepository(AnimeDetailsActivity instance,
      MediaRepository mediaRepository) {
    instance.mediaRepository = mediaRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.checkVpn")
  @Named("vpn")
  public static void injectCheckVpn(AnimeDetailsActivity instance, boolean checkVpn) {
    instance.checkVpn = checkVpn;
  }

  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.provideSnifferCheck")
  @Named("sniffer")
  ...
  @InjectedFieldSignature("com.f08movies.ui.animes.AnimeDetailsActivity.provideRootCheck")
  @Named("root")
