...
public class BrowserProgressBarBindingImpl extends BrowserProgressBarBinding  {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelObserveUrlFetchState((androidx.lifecycle.LiveData<com.f08movies.ui.downloadmanager.ui.browser.BrowserViewModel.UrlFetchState>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelObserveUrlFetchState(androidx.lifecycle.LiveData<com.f08movies.ui.downloadmanager.ui.browser.BrowserViewModel.UrlFetchState> ViewModelObserveUrlFetchState, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.LiveData<com.f08movies.ui.downloadmanager.ui.browser.BrowserViewModel.UrlFetchState> viewModelObserveUrlFetchState = null;
        boolean viewModelObserveUrlFetchStateUrlFetchStateFETCHING = false;
        com.f08movies.ui.downloadmanager.ui.browser.BrowserViewModel.UrlFetchState viewModelObserveUrlFetchStateGetValue = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                viewModelObserveUrlFetchStateUrlFetchStateFETCHING = (viewModelObserveUrlFetchStateGetValue) == (com.f08movies.ui.downloadmanager.ui.browser.BrowserViewModel.UrlFetchState.FETCHING);
            if((dirtyFlags & 0x7L) != 0) {
