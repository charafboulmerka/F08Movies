...
public class ActivityFilemanagerDialogBindingImpl extends ActivityFilemanagerDialogBinding  {
    ...
    private ActivityFilemanagerDialogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.f08movies.ui.downloadmanager.ui.customview.ThemedSwipeRefreshLayout) bindings[8]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.enableSystemManagerButton == variableId) {
            ...
            setViewModel((com.f08movies.ui.downloadmanager.ui.filemanager.FileManagerViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.f08movies.ui.downloadmanager.ui.filemanager.FileManagerViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.f08movies.ui.downloadmanager.ui.filemanager.FileManagerConfig viewModelConfig = null;
        ...
        com.f08movies.ui.downloadmanager.ui.filemanager.FileManagerViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    viewModelConfigShowModeFileManagerConfigSAVEFILEMODE = (viewModelConfigShowMode) == (com.f08movies.ui.downloadmanager.ui.filemanager.FileManagerConfig.SAVE_FILE_MODE);
                    // read viewModel.config.showMode == FileManagerConfig.DIR_CHOOSER_MODE
                    viewModelConfigShowModeFileManagerConfigDIRCHOOSERMODE = (viewModelConfigShowMode) == (com.f08movies.ui.downloadmanager.ui.filemanager.FileManagerConfig.DIR_CHOOSER_MODE);
                if((dirtyFlags & 0xcL) != 0) {
