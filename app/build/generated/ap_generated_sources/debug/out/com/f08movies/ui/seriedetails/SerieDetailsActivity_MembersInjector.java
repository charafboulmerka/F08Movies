...
public final class SerieDetailsActivity_MembersInjector implements MembersInjector<SerieDetailsActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.checkVpn")
  @Named("vpn")
  public static void injectCheckVpn(SerieDetailsActivity instance, boolean checkVpn) {
    instance.checkVpn = checkVpn;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.provideRootCheck")
  @Named("root")
  ...
  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.provideSnifferCheck")
  @Named("sniffer")
  ...
  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.mediaRepository")
  public static void injectMediaRepository(SerieDetailsActivity instance,
      MediaRepository mediaRepository) {
    instance.mediaRepository = mediaRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.settingReady")
  @Named("ready")
  ...
  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.settingsManager")
  public static void injectSettingsManager(SerieDetailsActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.tokenManager")
  public static void injectTokenManager(SerieDetailsActivity instance, TokenManager tokenManager) {
    instance.tokenManager = tokenManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.viewModelFactory")
  public static void injectViewModelFactory(SerieDetailsActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.sharedPreferences")
  public static void injectSharedPreferences(SerieDetailsActivity instance,
      SharedPreferences sharedPreferences) {
    instance.sharedPreferences = sharedPreferences;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.authManager")
  ...
  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.repository")
  public static void injectRepository(SerieDetailsActivity instance, MediaRepository repository) {
    instance.repository = repository;
  }

  @InjectedFieldSignature("com.f08movies.ui.seriedetails.SerieDetailsActivity.settingsRepository")
