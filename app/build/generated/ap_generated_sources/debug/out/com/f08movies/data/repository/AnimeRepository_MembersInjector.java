...
public final class AnimeRepository_MembersInjector implements MembersInjector<AnimeRepository> {
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.AnimeRepository.requestImdbApi")
  @Named("imdb")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.AnimeRepository.settingsManager")
  public static void injectSettingsManager(AnimeRepository instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.AnimeRepository.tokenManager")
