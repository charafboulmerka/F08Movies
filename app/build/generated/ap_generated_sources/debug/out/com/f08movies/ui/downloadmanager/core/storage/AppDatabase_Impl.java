package com.f08movies.ui.downloadmanager.core.storage;
...
import com.f08movies.ui.downloadmanager.core.storage.dao.BrowserBookmarksDao;
import com.f08movies.ui.downloadmanager.core.storage.dao.BrowserBookmarksDao_Impl;
import com.f08movies.ui.downloadmanager.core.storage.dao.DownloadDao;
import com.f08movies.ui.downloadmanager.core.storage.dao.DownloadDao_Impl;
import com.f08movies.ui.downloadmanager.core.storage.dao.UserAgentDao;
import com.f08movies.ui.downloadmanager.core.storage.dao.UserAgentDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(8) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoDownloadInfo.equals(_existingDownloadInfo)) {
          return new RoomOpenHelper.ValidationResult(false, "DownloadInfo(com.f08movies.ui.downloadmanager.core.model.data.entity.DownloadInfo).\n"
                  + " Expected:\n" + _infoDownloadInfo + "\n"
        ...
        if (! _infoDownloadPiece.equals(_existingDownloadPiece)) {
          return new RoomOpenHelper.ValidationResult(false, "DownloadPiece(com.f08movies.ui.downloadmanager.core.model.data.entity.DownloadPiece).\n"
                  + " Expected:\n" + _infoDownloadPiece + "\n"
        ...
        if (! _infoDownloadInfoHeaders.equals(_existingDownloadInfoHeaders)) {
          return new RoomOpenHelper.ValidationResult(false, "download_info_headers(com.f08movies.ui.downloadmanager.core.model.data.entity.Header).\n"
        ...
        if (! _infoUserAgent.equals(_existingUserAgent)) {
          return new RoomOpenHelper.ValidationResult(false, "UserAgent(com.f08movies.ui.downloadmanager.core.model.data.entity.UserAgent).\n"
                  + " Expected:\n" + _infoUserAgent + "\n"
                  + " Found:\n" + _existingUserAgent);
        }
        ...
        if (! _infoBrowserBookmark.equals(_existingBrowserBookmark)) {
          return new RoomOpenHelper.ValidationResult(false, "BrowserBookmark(com.f08movies.ui.downloadmanager.core.model.data.entity.BrowserBookmark).\n"
