...
public final class MediaRepository_MembersInjector implements MembersInjector<MediaRepository> {
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.requestImdbApi")
  @Named("imdb")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.requestOpenSubs")
  @Named("opensubs")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.settingsManager")
  public static void injectSettingsManager(MediaRepository instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.requestAppApi")
  @Named("callback")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.utilsc")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.cuePoint")
  @Named("cuepoint")
  public static void injectCuePoint(MediaRepository instance, String cuePoint) {
    instance.cuePoint = cuePoint;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.cuepointUrl")
  @Named("cuepointUrl")
  public static void injectCuepointUrl(MediaRepository instance, String cuepointUrl) {
    instance.cuepointUrl = cuepointUrl;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.requestStatusApi")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.adplaying")
  @Named("adplaying")
  public static void injectAdplaying(MediaRepository instance, ApiInterface adplaying) {
    instance.adplaying = adplaying;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.fsm")
  @Named("loading")
  public static void injectFsm(MediaRepository instance, Fsm fsm) {
    instance.fsm = fsm;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.MediaRepository.requestAuth")
  @Named("Auth")
