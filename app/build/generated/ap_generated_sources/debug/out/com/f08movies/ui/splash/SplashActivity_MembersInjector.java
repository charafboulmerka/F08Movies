package com.f08movies.ui.splash;
...
public final class SplashActivity_MembersInjector implements MembersInjector<SplashActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.settingsRepository")
  public static void injectSettingsRepository(SplashActivity instance,
      SettingsRepository settingsRepository) {
    instance.settingsRepository = settingsRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.settingsManager")
  public static void injectSettingsManager(SplashActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.adsManager")
  public static void injectAdsManager(SplashActivity instance, AdsManager adsManager) {
    instance.adsManager = adsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.statusManager")
  ...
  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.viewModelFactory")
  public static void injectViewModelFactory(SplashActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.provideApplicationInfo")
  @Named("sniffer")
  ...
  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.packageName")
  @Named("package_name")
  public static void injectPackageName(SplashActivity instance, String packageName) {
    instance.packageName = packageName;
  }

  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.checkVpn")
  @Named("vpn")
  public static void injectCheckVpn(SplashActivity instance, boolean checkVpn) {
    instance.checkVpn = checkVpn;
  }

  @InjectedFieldSignature("com.f08movies.ui.splash.SplashActivity.provideFirebaseRemoteConfig")
