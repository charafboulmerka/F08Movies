package com.f08movies.ui.streaming;
...
public final class StreamingetailsActivity_MembersInjector implements MembersInjector<StreamingetailsActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.checkVpn")
  @Named("vpn")
  public static void injectCheckVpn(StreamingetailsActivity instance, boolean checkVpn) {
    instance.checkVpn = checkVpn;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.provideSnifferCheck")
  @Named("sniffer")
  ...
  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.provideRootCheck")
  @Named("root")
  ...
  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.viewModelFactory")
  public static void injectViewModelFactory(StreamingetailsActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.sharedPreferences")
  public static void injectSharedPreferences(StreamingetailsActivity instance,
      SharedPreferences sharedPreferences) {
    instance.sharedPreferences = sharedPreferences;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.settingReady")
  @Named("ready")
  ...
  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.sharedPreferencesEditor")
  ...
  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.settingsManager")
  public static void injectSettingsManager(StreamingetailsActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.settingsRepository")
  public static void injectSettingsRepository(StreamingetailsActivity instance,
      SettingsRepository settingsRepository) {
    instance.settingsRepository = settingsRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.authRepository")
  public static void injectAuthRepository(StreamingetailsActivity instance,
      AuthRepository authRepository) {
    instance.authRepository = authRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.mediaRepository")
  public static void injectMediaRepository(StreamingetailsActivity instance,
      MediaRepository mediaRepository) {
    instance.mediaRepository = mediaRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.cuePoint")
  @Named("cuepoint")
  public static void injectCuePoint(StreamingetailsActivity instance, String cuePoint) {
    instance.cuePoint = cuePoint;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.cuepointUrl")
  @Named("cuepointUrl")
  public static void injectCuepointUrl(StreamingetailsActivity instance, String cuepointUrl) {
    instance.cuepointUrl = cuepointUrl;
  }

  @InjectedFieldSignature("com.f08movies.ui.streaming.StreamingetailsActivity.authManager")
