...
public final class CastDetailsActivity_MembersInjector implements MembersInjector<CastDetailsActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.viewModelFactory")
  public static void injectViewModelFactory(CastDetailsActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.sharedPreferences")
  public static void injectSharedPreferences(CastDetailsActivity instance,
      SharedPreferences sharedPreferences) {
    instance.sharedPreferences = sharedPreferences;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.sharedPreferencesEditor")
  ...
  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.settingsManager")
  public static void injectSettingsManager(CastDetailsActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.settingsRepository")
  public static void injectSettingsRepository(CastDetailsActivity instance,
      SettingsRepository settingsRepository) {
    instance.settingsRepository = settingsRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.authRepository")
  public static void injectAuthRepository(CastDetailsActivity instance,
      AuthRepository authRepository) {
    instance.authRepository = authRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.mediaRepository")
  public static void injectMediaRepository(CastDetailsActivity instance,
      MediaRepository mediaRepository) {
    instance.mediaRepository = mediaRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.settingReady")
  @Named("ready")
  ...
  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.cuePoint")
  @Named("cuepoint")
  public static void injectCuePoint(CastDetailsActivity instance, String cuePoint) {
    instance.cuePoint = cuePoint;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.cuepointUrl")
  @Named("cuepointUrl")
  public static void injectCuepointUrl(CastDetailsActivity instance, String cuepointUrl) {
    instance.cuepointUrl = cuepointUrl;
  }

  @InjectedFieldSignature("com.f08movies.ui.casts.CastDetailsActivity.authManager")
