...
public class FragmentHomeBindingImpl extends FragmentHomeBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            ...
            new int[] {2},
            new int[] {com.f08movies.R.layout.main_toolbar});
    ...
    private FragmentHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.f08movies.util.GridItemImageView) bindings[74]
            ...
            , (com.f08movies.util.GridItemImageView) bindings[57]
            ...
            , (com.f08movies.util.GridItemImageView) bindings[60]
            , (me.relex.circleindicator.CircleIndicator2) bindings[9]
            , (com.f08movies.util.GridItemImageView) bindings[68]
            ...
            , (com.f08movies.util.GridItemImageView) bindings[77]
            ...
            , (com.f08movies.util.GridItemImageView) bindings[65]
            , (android.widget.ProgressBar) bindings[80]
            , (com.f08movies.util.GridItemImageView) bindings[51]
            ...
            , (com.f08movies.util.GridItemImageView) bindings[71]
            , (com.f08movies.databinding.MainToolbarBinding) bindings[2]
            , (android.widget.ImageView) bindings[37]
            , (com.f08movies.util.GridItemImageView) bindings[54]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.controller == variableId) {
            setController((com.f08movies.ui.users.MenuHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setController(@Nullable com.f08movies.ui.users.MenuHandler Controller) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeToolbar((com.f08movies.databinding.MainToolbarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeToolbar(com.f08movies.databinding.MainToolbarBinding Toolbar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
