...
public class ItemTopttenBindingImpl extends ItemTopttenBinding  {
    ...
    // views
    @NonNull
    private final com.f08movies.util.GridItemImageView mboundView1;
    @NonNull
    private final com.f08movies.util.GridItemImageView mboundView2;
    // variables
    // values
    // listeners
    ...
    private ItemTopttenBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (com.f08movies.util.GridItemImageView) bindings[4]
            , (com.f08movies.util.Outline) bindings[9]
        ...
        this.mboundView1 = (com.f08movies.util.GridItemImageView) bindings[1];
        this.mboundView1.setTag(null);
        this.mboundView2 = (com.f08movies.util.GridItemImageView) bindings[2];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.controller == variableId) {
            setController((com.f08movies.util.AppController) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setController(@Nullable com.f08movies.util.AppController Controller) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeController((com.f08movies.util.AppController) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeController(com.f08movies.util.AppController Controller, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.f08movies.util.AppController controller = mController;
