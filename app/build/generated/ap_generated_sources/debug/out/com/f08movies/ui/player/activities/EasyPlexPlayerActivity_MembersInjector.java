...
public final class EasyPlexPlayerActivity_MembersInjector implements MembersInjector<EasyPlexPlayerActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.viewModelFactory")
  public static void injectViewModelFactory(EasyPlexPlayerActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.playerReady")
  @Named("mainplayer")
  public static void injectPlayerReady(EasyPlexPlayerActivity instance, String playerReady) {
    instance.playerReady = playerReady;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.settingReady")
  @Named("ready")
  ...
  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.sharedPreferences")
  public static void injectSharedPreferences(EasyPlexPlayerActivity instance,
      SharedPreferences sharedPreferences) {
    instance.sharedPreferences = sharedPreferences;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.authManager")
  ...
  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.adsManager")
  public static void injectAdsManager(EasyPlexPlayerActivity instance, AdsManager adsManager) {
    instance.adsManager = adsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.settingsManager")
  public static void injectSettingsManager(EasyPlexPlayerActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.cuepointUrl")
  @Named("cuepointUrl")
  public static void injectCuepointUrl(EasyPlexPlayerActivity instance, String cuepointUrl) {
    instance.cuepointUrl = cuepointUrl;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.cuePoint")
  @Named("cuepoint")
  public static void injectCuePoint(EasyPlexPlayerActivity instance, String cuePoint) {
    instance.cuePoint = cuePoint;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.cuePointY")
  @Named("cuepointY")
  public static void injectCuePointY(EasyPlexPlayerActivity instance, String cuePointY) {
    instance.cuePointY = cuePointY;
  }

  @InjectedFieldSignature("com.f08movies.ui.player.activities.EasyPlexPlayerActivity.cuePointN")
  @Named("cuepointN")
