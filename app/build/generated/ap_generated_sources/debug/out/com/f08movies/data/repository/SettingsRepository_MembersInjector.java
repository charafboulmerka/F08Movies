...
public final class SettingsRepository_MembersInjector implements MembersInjector<SettingsRepository> {
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.SettingsRepository.apiInterface")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.SettingsRepository.settingsManager")
  public static void injectSettingsManager(SettingsRepository instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.data.repository.SettingsRepository.requestStatusApi")
  @Named("status")
  ...
  @InjectedFieldSignature("com.f08movies.data.repository.SettingsRepository.requestImdbApi")
  @Named("imdb")
