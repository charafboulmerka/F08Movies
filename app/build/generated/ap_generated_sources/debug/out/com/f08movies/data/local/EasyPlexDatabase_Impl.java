...
import com.f08movies.data.local.dao.AnimesDao_Impl;
import com.f08movies.data.local.dao.DownloadDao;
import com.f08movies.data.local.dao.DownloadDao_Impl;
import com.f08movies.data.local.dao.HistoryDao;
import com.f08movies.data.local.dao.HistoryDao_Impl;
import com.f08movies.data.local.dao.MoviesDao;
import com.f08movies.data.local.dao.MoviesDao_Impl;
import com.f08movies.data.local.dao.ResumeDao;
import com.f08movies.data.local.dao.ResumeDao_Impl;
import com.f08movies.data.local.dao.SeriesDao;
import com.f08movies.data.local.dao.SeriesDao_Impl;
import com.f08movies.data.local.dao.StreamListDao;
import com.f08movies.data.local.dao.StreamListDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(52) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoMovies.equals(_existingMovies)) {
          return new RoomOpenHelper.ValidationResult(false, "movies(com.f08movies.data.local.entity.Media).\n"
                  + " Expected:\n" + _infoMovies + "\n"
                  + " Found:\n" + _existingMovies);
        }
        ...
        if (! _infoSeries.equals(_existingSeries)) {
          return new RoomOpenHelper.ValidationResult(false, "series(com.f08movies.data.local.entity.Series).\n"
                  + " Expected:\n" + _infoSeries + "\n"
                  + " Found:\n" + _existingSeries);
        }
        ...
        if (! _infoAnimes.equals(_existingAnimes)) {
          return new RoomOpenHelper.ValidationResult(false, "animes(com.f08movies.data.local.entity.Animes).\n"
                  + " Expected:\n" + _infoAnimes + "\n"
                  + " Found:\n" + _existingAnimes);
        }
        ...
        if (! _infoDownload.equals(_existingDownload)) {
          return new RoomOpenHelper.ValidationResult(false, "download(com.f08movies.data.local.entity.Download).\n"
                  + " Expected:\n" + _infoDownload + "\n"
                  + " Found:\n" + _existingDownload);
        }
        ...
        if (! _infoHistory.equals(_existingHistory)) {
          return new RoomOpenHelper.ValidationResult(false, "history(com.f08movies.data.local.entity.History).\n"
                  + " Expected:\n" + _infoHistory + "\n"
                  + " Found:\n" + _existingHistory);
        }
        ...
        if (! _infoStream.equals(_existingStream)) {
          return new RoomOpenHelper.ValidationResult(false, "stream(com.f08movies.data.local.entity.Stream).\n"
                  + " Expected:\n" + _infoStream + "\n"
                  + " Found:\n" + _existingStream);
        }
        ...
        if (! _infoResume.equals(_existingResume)) {
          return new RoomOpenHelper.ValidationResult(false, "resume(com.f08movies.data.model.media.Resume).\n"
                  + " Expected:\n" + _infoResume + "\n"
                  + " Found:\n" + _existingResume);
        }
