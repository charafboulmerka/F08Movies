...
public final class PasswordForget_MembersInjector implements MembersInjector<PasswordForget> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.login.PasswordForget.androidInjector")
  public static void injectAndroidInjector(PasswordForget instance,
      DispatchingAndroidInjector<Object> androidInjector) {
    instance.androidInjector = androidInjector;
  }

  @InjectedFieldSignature("com.f08movies.ui.login.PasswordForget.sharedPreferencesEditor")
  ...
  @InjectedFieldSignature("com.f08movies.ui.login.PasswordForget.tokenManager")
  public static void injectTokenManager(PasswordForget instance, TokenManager tokenManager) {
    instance.tokenManager = tokenManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.login.PasswordForget.settingsManager")
  public static void injectSettingsManager(PasswordForget instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.login.PasswordForget.viewModelFactory")
