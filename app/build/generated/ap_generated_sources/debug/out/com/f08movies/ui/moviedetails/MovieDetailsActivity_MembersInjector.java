package com.f08movies.ui.moviedetails;
...
public final class MovieDetailsActivity_MembersInjector implements MembersInjector<MovieDetailsActivity> {
  ...
  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.viewModelFactory")
  public static void injectViewModelFactory(MovieDetailsActivity instance,
      ViewModelProvider.Factory viewModelFactory) {
    instance.viewModelFactory = viewModelFactory;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.sharedPreferences")
  public static void injectSharedPreferences(MovieDetailsActivity instance,
      SharedPreferences sharedPreferences) {
    instance.sharedPreferences = sharedPreferences;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.sharedPreferencesEditor")
  ...
  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.settingsManager")
  public static void injectSettingsManager(MovieDetailsActivity instance,
      SettingsManager settingsManager) {
    instance.settingsManager = settingsManager;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.settingsRepository")
  public static void injectSettingsRepository(MovieDetailsActivity instance,
      SettingsRepository settingsRepository) {
    instance.settingsRepository = settingsRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.authRepository")
  public static void injectAuthRepository(MovieDetailsActivity instance,
      AuthRepository authRepository) {
    instance.authRepository = authRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.mediaRepository")
  public static void injectMediaRepository(MovieDetailsActivity instance,
      MediaRepository mediaRepository) {
    instance.mediaRepository = mediaRepository;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.settingReady")
  @Named("ready")
  ...
  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.cuePoint")
  @Named("cuepoint")
  public static void injectCuePoint(MovieDetailsActivity instance, String cuePoint) {
    instance.cuePoint = cuePoint;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.cuepointUrl")
  @Named("cuepointUrl")
  public static void injectCuepointUrl(MovieDetailsActivity instance, String cuepointUrl) {
    instance.cuepointUrl = cuepointUrl;
  }

  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.authManager")
  ...
  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.provideRootCheck")
  @Named("root")
  ...
  @InjectedFieldSignature("com.f08movies.ui.moviedetails.MovieDetailsActivity.tokenManager")
