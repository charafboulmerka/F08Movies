...
public class DialogAddDownloadBindingImpl extends DialogAddDownloadBinding  {
    ...
    private androidx.databinding.InverseBindingListener checksumandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel.params
            com.f08movies.ui.downloadmanager.ui.adddownload.AddDownloadParams viewModelParams = null;
            // viewModel
            com.f08movies.ui.downloadmanager.ui.adddownload.AddDownloadViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    private DialogAddDownloadBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (com.f08movies.ui.downloadmanager.ui.customview.ExpansionHeader) bindings[27]
            ...
            , (com.f08movies.ui.downloadmanager.ui.customview.FixHintTextInputEditText) bindings[9]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.f08movies.ui.downloadmanager.ui.adddownload.AddDownloadViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.f08movies.ui.downloadmanager.ui.adddownload.AddDownloadViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelParams((com.f08movies.ui.downloadmanager.ui.adddownload.AddDownloadParams) object, fieldId);
            case 1 :
    ...
    private boolean onChangeViewModelParams(com.f08movies.ui.downloadmanager.ui.adddownload.AddDownloadParams ViewModelParams, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x10089L) != 0) {
            ...
            com.f08movies.ui.downloadmanager.core.utils.BindingAdapterUtils.formatFileSize(this.freeSpace, viewModelParamsStorageFreeSpace, freeSpace.getResources().getString(R.string.storage_free_space));
        }
        if ((dirtyFlags & 0x10019L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x10109L) != 0) {
            ...
            com.f08movies.ui.downloadmanager.core.utils.BindingAdapterUtils.formatFileSize(this.size, viewModelParamsTotalBytes, size.getResources().getString(R.string.download_size));
        }
        if ((dirtyFlags & 0x10809L) != 0) {
            // api target 1
