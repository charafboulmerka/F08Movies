...
public class ActivitySettingBindingImpl extends ActivitySettingBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            ...
            new int[] {2},
            new int[] {com.f08movies.R.layout.main_toolbar_others});
    ...
    private ActivitySettingBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.f08movies.databinding.MainToolbarOthersBinding) bindings[2]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeToolbar((com.f08movies.databinding.MainToolbarOthersBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeToolbar(com.f08movies.databinding.MainToolbarOthersBinding Toolbar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
