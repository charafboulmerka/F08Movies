...
import static com.f08movies.util.Constants.PREF_FILE;
...
import com.f08movies.data.model.status.Status;
import com.f08movies.data.remote.ApiInterface;
import com.f08movies.data.remote.ServiceGenerator;
import com.f08movies.di.ViewModelModule;
...
import com.f08movies.ui.player.fsm.callback.Callback;
import com.f08movies.ui.player.fsm.callback.CuePointCallBack;
import com.f08movies.ui.player.fsm.callback.CuePointCallBackAd;
import com.f08movies.ui.player.fsm.callback.RetrieveAdCallback;
import com.f08movies.ui.player.fsm.concrete.FetchCuePointState;
