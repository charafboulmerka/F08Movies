...
import static com.f08movies.BuildConfig.APP_STARUP;
...
public abstract class Constants {
    ...
    public static final String SERVER_ENCODED = SC.obfuscate(Tools.encodeMainApiServer("http://192.168.1.180/public/api/"));
