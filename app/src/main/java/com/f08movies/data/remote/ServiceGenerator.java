...
import static com.f08movies.util.Constants.ACCEPT;
import static com.f08movies.util.Constants.APPLICATION_JSON;
import static com.f08movies.util.Constants.AUTHORISATION_BEARER_STRING;
import static com.f08movies.util.Constants.AUTHORIZATION;
import static com.f08movies.util.Constants.BEARER;
import static com.f08movies.util.Constants.CACHE_CONTROL;
import static com.f08movies.util.Constants.HXFILE;
import static com.f08movies.util.Constants.IMDB_BASE_URL;
import static com.f08movies.util.Constants.PACKAGE_NAME;
import static com.f08movies.util.Constants.PREFS2;
import static com.f08movies.util.Constants.SERVER_BASE_URL;
import static com.f08movies.util.Constants.SERVER_OPENSUBS_URL;
...
import com.f08movies.ui.player.helpers.MediaHelper;
