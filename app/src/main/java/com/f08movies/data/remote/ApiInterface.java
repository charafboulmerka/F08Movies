package com.f08movies.data.remote;

import com.f08movies.data.local.entity.Media;
import com.f08movies.data.model.MovieResponse;
import com.f08movies.data.model.ads.Ads;
import com.f08movies.data.model.auth.Login;
import com.f08movies.data.model.auth.Profile;
import com.f08movies.data.model.auth.Rating;
import com.f08movies.data.model.auth.StripeStatus;
...
import com.f08movies.data.model.credits.MovieCreditsResponse;
import com.f08movies.data.model.episode.Episode;
import com.f08movies.data.model.episode.EpisodeStream;
import com.f08movies.data.model.episode.EpisodesByGenre;
...
import com.f08movies.data.model.search.SearchResponse;
import com.f08movies.data.model.settings.Decrypter;
import com.f08movies.data.model.settings.Settings;
import com.f08movies.data.model.status.Status;
import com.f08movies.data.model.stream.MediaStream;
import com.f08movies.data.model.substitles.ExternalID;
import com.f08movies.data.model.substitles.ImdbLangs;
import com.f08movies.data.model.substitles.Opensub;
import com.f08movies.data.model.suggestions.Suggest;
import com.f08movies.data.model.upcoming.Upcoming;
