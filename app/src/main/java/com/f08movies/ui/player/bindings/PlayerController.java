package com.f08movies.ui.player.bindings;

import static android.content.Context.MODE_PRIVATE;
import static android.view.View.VISIBLE;
import static com.f08movies.EasyPlexApp.getContext;
import static com.f08movies.util.Constants.AUTO_PLAY;
import static com.f08movies.util.Constants.CUSTOM_SEEK_CONTROL_STATE;
import static com.f08movies.util.Constants.DEFAULT_FREQUENCY;
import static com.f08movies.util.Constants.DEFAULT_MEDIA_COVER;
import static com.f08movies.util.Constants.EDIT_CUSTOM_SEEK_CONTROL_STATE;
...
import com.f08movies.ui.player.enums.ScaleMode;
import com.f08movies.ui.player.fsm.state_machine.FsmPlayerApi;
import com.f08movies.ui.player.interfaces.PlaybackActionCallback;
import com.f08movies.ui.player.interfaces.TubiPlaybackControlInterface;
import com.f08movies.ui.player.presenters.ScalePresenter;
import com.f08movies.ui.player.utilities.ExoPlayerLogger;
import com.f08movies.ui.player.utilities.PlayerDeviceUtils;
import com.f08movies.ui.player.views.EasyPlexPlayerView;
