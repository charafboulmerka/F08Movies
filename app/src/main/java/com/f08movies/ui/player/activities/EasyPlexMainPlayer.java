package com.f08movies.ui.player.activities;
...
import static com.f08movies.EasyPlexApp.getContext;
import static com.f08movies.ui.player.utilities.ExoPlayerLogger.i;
import static com.f08movies.ui.player.utilities.ExoPlayerLogger.v;
import static com.f08movies.util.Constants.AUTO_PLAY;
import static com.f08movies.util.Constants.E;
import static com.f08movies.util.Constants.EP;
import static com.f08movies.util.Constants.S0;
import static com.f08movies.util.Constants.SEASONS;
import static com.f08movies.util.Constants.SERVER_BASE_URL;
import static com.f08movies.util.Constants.SPECIALS;
import static com.f08movies.util.Constants.SUBSTITLE_LOCATION;
import static com.f08movies.util.Constants.SUBSTITLE_SUB_FILENAME_ZIP;
import static com.f08movies.util.Constants.SUBS_DEFAULT_LANG;
import static com.f08movies.util.Constants.UPNEXT;
import static com.f08movies.util.Constants.VLC_PACKAGE_NAME;
import static com.f08movies.util.Constants.ZIP_FILE_NAME;
import static com.f08movies.util.Constants.ZIP_FILE_NAME2;
import static com.f08movies.util.Constants.ZIP_FILE_NAME3;
import static com.f08movies.util.Constants.ZIP_FILE_NAME4;
import static com.f08movies.util.Tools.EXTRA_HEADERS;
import static com.f08movies.util.Tools.HEADERS;
import static com.f08movies.util.Tools.POSTER;
import static com.f08movies.util.Tools.SECURE_URI;
import static com.f08movies.util.Tools.TITLE;
import static com.f08movies.util.Tools.USER_AGENT;
import static com.f08movies.util.Tools.VIDEOTYPE;
...
import com.f08movies.data.datasource.movie.MovieDataSource;
import com.f08movies.data.datasource.stream.StreamDataSource;
import com.f08movies.data.datasource.stream.StreamingDataSourceFactory;
import com.f08movies.data.local.entity.History;
import com.f08movies.data.local.entity.Media;
import com.f08movies.data.model.MovieResponse;
...
import com.f08movies.data.model.episode.EpisodeStream;
import com.f08movies.data.model.genres.Genre;
import com.f08movies.data.model.genres.GenresByID;
import com.f08movies.data.model.genres.GenresData;
import com.f08movies.data.model.media.MediaModel;
import com.f08movies.data.model.media.Resume;
import com.f08movies.data.model.serie.Season;
import com.f08movies.data.model.stream.MediaStream;
import com.f08movies.data.model.substitles.MediaSubstitle;
import com.f08movies.data.model.substitles.Opensub;
...
import com.f08movies.ui.player.adapters.AnimesEpisodesPlayerAdapter;
import com.f08movies.ui.player.adapters.AnimesListAdapter;
import com.f08movies.ui.player.adapters.ClickDetectListner;
import com.f08movies.ui.player.adapters.EpisodesPlayerAdapter;
import com.f08movies.ui.player.adapters.MovieQualitiesAdapter;
import com.f08movies.ui.player.adapters.MoviesListAdapter;
import com.f08movies.ui.player.adapters.SerieQualitiesAdapter;
import com.f08movies.ui.player.adapters.SeriesListAdapter;
import com.f08movies.ui.player.adapters.StreamingListAdapter;
import com.f08movies.ui.player.adapters.StreamingQualitiesAdapter;
import com.f08movies.ui.player.adapters.SubstitlesAdapter;
...
import com.f08movies.ui.player.fsm.concrete.AdPlayingState;
import com.f08movies.ui.player.fsm.concrete.VpaidState;
...
import com.f08movies.ui.player.fsm.state_machine.FsmPlayerApi;
import com.f08movies.ui.player.interfaces.AutoPlay;
import com.f08movies.ui.player.interfaces.DoublePlayerInterface;
...
import com.f08movies.ui.player.utilities.PlayerDeviceUtils;
import com.f08movies.ui.player.utilities.TrackSelectionDialog;
import com.f08movies.ui.player.views.UIControllerView;
import com.f08movies.ui.settings.SettingsActivity;
import com.f08movies.ui.viewmodels.PlayerViewModel;
import com.f08movies.util.Constants;
import com.f08movies.util.DialogHelper;
import com.f08movies.util.DownloadFileAsync;
import com.f08movies.util.GlideApp;
import com.f08movies.util.SpacingItemDecoration;
