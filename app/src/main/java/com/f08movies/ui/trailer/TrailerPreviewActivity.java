package com.f08movies.ui.trailer;

import static com.bumptech.glide.load.resource.bitmap.BitmapTransitionOptions.withCrossFade;
import static com.f08movies.util.Constants.ARG_MOVIE;
import static com.f08movies.util.Constants.MOVIE;
import static com.f08movies.util.Constants.SERIE;
import static com.f08movies.util.Constants.SERVER_BASE_URL;
import static com.f08movies.util.Tools.hideSystemPlayerUi;
import static com.f08movies.util.Tools.loadMiniLogo;
import static com.f08movies.util.Tools.loadToolbar;
import static com.f08movies.util.Tools.setSystemBarTransparent;
...
import com.f08movies.databinding.UpcomingTitlesOverviewBinding;
