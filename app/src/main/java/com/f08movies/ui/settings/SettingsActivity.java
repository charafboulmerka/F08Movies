package com.f08movies.ui.settings;

import static android.view.View.GONE;
import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static com.f08movies.util.Constants.AUTO_PLAY;
import static com.f08movies.util.Constants.EXTENTIONS;
import static com.f08movies.util.Constants.PLAYER_ASPECT_RATIO;
import static com.f08movies.util.Constants.PREMUIM;
import static com.f08movies.util.Constants.SOFTWARE_EXTENTIONS;
import static com.f08movies.util.Constants.SUBSCRIPTIONS;
import static com.f08movies.util.Constants.SUBS_BACKGROUND;
import static com.f08movies.util.Constants.SUBS_DEFAULT_LANG;
import static com.f08movies.util.Constants.SUBS_SIZE;
import static com.f08movies.util.Constants.SWITCH_PUSH_NOTIFICATION;
...
import com.f08movies.databinding.ActivitySettingBinding;
