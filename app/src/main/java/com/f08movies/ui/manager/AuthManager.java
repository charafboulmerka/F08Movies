package com.f08movies.ui.manager;
...
import static com.f08movies.util.Constants.AUTH_EMAIL;
import static com.f08movies.util.Constants.AUTH_EXPIRED_DATE;
import static com.f08movies.util.Constants.AUTH_ID;
import static com.f08movies.util.Constants.AUTH_NAME;
import static com.f08movies.util.Constants.PREMUIM;
import static com.f08movies.util.Constants.PREMUIM_MANUAL;
import static com.f08movies.util.Constants.USER_PROFILE_AVATAR;
import static com.f08movies.util.Constants.USER_PROFILE_ID;
import static com.f08movies.util.Constants.USER_PROFILE_NAME;
