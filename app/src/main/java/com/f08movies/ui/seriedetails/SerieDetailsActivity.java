...
import static com.f08movies.util.Constants.UNITY_ADS_BANNER_HEIGHT;
import static com.f08movies.util.Constants.UNITY_ADS_BANNER_WIDTH;
...
import com.f08movies.databinding.SerieDetailsBinding;
