...
package com.f08movies.ui.downloadmanager.core.utils;
...
import com.f08movies.ui.downloadmanager.core.RepositoryHelper;
import com.f08movies.ui.downloadmanager.core.filter.DownloadFilter;
import com.f08movies.ui.downloadmanager.core.filter.DownloadFilterCollection;
...
import com.f08movies.ui.downloadmanager.core.sorting.DownloadSorting;
import com.f08movies.ui.downloadmanager.core.sorting.DownloadSortingComparator;
import com.f08movies.ui.downloadmanager.core.system.FileSystemFacade;
import com.f08movies.ui.downloadmanager.core.system.SafFileSystem;
import com.f08movies.ui.downloadmanager.core.system.SystemFacade;
import com.f08movies.ui.downloadmanager.core.system.SystemFacadeHelper;
import com.f08movies.ui.downloadmanager.receiver.BootReceiver;
import com.f08movies.ui.downloadmanager.ui.main.DownloadItem;
import com.f08movies.ui.downloadmanager.ui.main.drawer.DrawerGroup;
import com.f08movies.ui.downloadmanager.ui.main.drawer.DrawerGroupItem;
...
import static com.f08movies.ui.downloadmanager.core.utils.MimeTypeUtils.DEFAULT_MIME_TYPE;
import static com.f08movies.ui.downloadmanager.core.utils.MimeTypeUtils.MIME_TYPE_DELIMITER;
...
public class Utils {
    ...
    public static void enableBrowserLauncherIcon(@NonNull Context context, boolean enable) {
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.easyplexdemoapp.ui.downloadmanager.ui.browser.BrowserIcon"),
    ...
    public static void disableBrowserFromSystem(@NonNull Context context, boolean disable) {
        ...
        int flag = (disable ?
                ...
                PackageManager.COMPONENT_ENABLED_STATE_ENABLED);
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.easyplexdemoapp.ui.downloadmanager.ui.browser.Browser"),
                flag, PackageManager.DONT_KILL_APP);
    }
