...
package com.f08movies.ui.downloadmanager.ui.main;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static com.f08movies.util.Constants.ARG_MOVIE;
import static com.f08movies.util.Constants.ARG_MOVIE_HISTORY;
...
import com.f08movies.ui.downloadmanager.ui.Selectable;
                                        ...
                                        PopupMenu.OnMenuItemClickListener clickListener = menuItem -> {
                                            ...
                                            if (provider1.isQueueDetached() && provider1.getCount() > 0) {
                                                if ((menuItem.getItemId() == R.id.action_play_now)
                                                    ...
                                                    MediaQueueItem[] items = com.f08movies.ui.player.cast.utils.Utils
