package com.f08movies.ui.search;
...
import com.f08movies.databinding.ItemSuggest2Binding;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchViewHolder> {
    ...
    class SearchViewHolder extends RecyclerView.ViewHolder {
        ...
        private void createAndLoadRewardedAd() {
            ...
            IronSource.init(context, settingsManager.getSettings().getIronsourceAppKey(), IronSource.AD_UNIT.REWARDED_VIDEO,IronSource.AD_UNIT.INTERSTITIAL);
